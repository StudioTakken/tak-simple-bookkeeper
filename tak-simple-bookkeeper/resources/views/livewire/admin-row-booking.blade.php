...
"
    ...
    <td class="text-sm text-gray-900 font-light px-6 py-1 whitespace-nowrap">{{ $booking->id }}</td>
    <td class="text-sm text-gray-900 font-light px-6 py-1 whitespace-nowrap">{{ $booking->parent_id }}</td>
    <td class="text-sm text-gray-900 font-light px-6 py-1 whitespace-nowrap">{{ $booking->date }}</td>
    <td class="text-sm text-gray-900 font-light px-6 py-1 whitespace-nowrap">{{ $booking->description }}
    </td>



    @if ($booking->plus_min_int < 0)
        <td class="text-sm text-gray-900 font-light px-6 py-1 whitespace-nowrap text-right">
    ...
    <td
        class="text-sm @if ($booking->plus_min_int < 0) text-red-600 @else text-gray-900 @endif font-light px-6 py-1 whitespace-nowrap text-right">
    ...
    <td class="text-sm text-gray-900 font-light px-6 py-1 whitespace-nowrap">{{ $booking->bank_code }}
    </td>
    <td class="text-sm text-gray-900 font-light px-6 py-1 whitespace-nowrap">
        {{ $booking->account }}
    </td>
    ...
    <td class="text-sm text-gray-900 font-light px-6 py-1 whitespace-nowrap">{{ $booking->tags }}</td>
    <td class="text-sm text-gray-900 font-light px-6 py-1 w-60">
